...
#define MAX_SPECIES_PALDEAN_FORMS (SPECIES_TERAPAGOS_STELLAR)

#define SPECIES_PLZA_FORMS_START (MAX_SPECIES_PALDEAN_FORMS + 1) // 1393
...
#define MAX_SPECIES_INCLUDING_FORMS (SPECIES_MEGA_FALINKS)  // 1393 + 26
