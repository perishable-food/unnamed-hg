...
#define SPECIES_MEGA_DECIDUEYE (MAX_SPECIES_PLZA_MEGAS_FORM_NUM + 1)
#define SPECIES_MEGA_INCINEROAR (MAX_SPECIES_PLZA_MEGAS_FORM_NUM + 2)
#define SPECIES_MEGA_PRIMARINA (MAX_SPECIES_PLZA_MEGAS_FORM_NUM + 3)
#define SPECIES_MEGA_DEDENNE (MAX_SPECIES_PLZA_MEGAS_FORM_NUM + 4)
#define SPECIES_MEGA_LEDIAN (MAX_SPECIES_PLZA_MEGAS_FORM_NUM + 5)
#define SPECIES_MEGA_MARSHADOW (MAX_SPECIES_PLZA_MEGAS_FORM_NUM + 6)

#define MAX_UGH_FAKEMON (SPECIES_MEGA_MARSHADOW)

#define MAX_SPECIES_INCLUDING_FORMS (MAX_SPECIES_CANONICAL_FORM_NUM + MAX_UGH_FAKEMON)  // 1476
