...
#define SPECIES_PUFFUGU (MAX_CANONICAL_MON_NUM + 3)
#define SPECIES_TUFFUGU (MAX_CANONICAL_MON_NUM + 4)
...
#define SPECIES_LEGACY_FORMS_START (MAX_SPECIES_PLZA_MEGAS_FORM_NUM + 1)

#define SPECIES_DEOXYS_ATTACK  (SPECIES_LEGACY_FORMS_START)
#define SPECIES_DEOXYS_DEFENSE (SPECIES_LEGACY_FORMS_START + 1)
#define SPECIES_DEOXYS_SPEED   (SPECIES_LEGACY_FORMS_START + 2)

#define SPECIES_UNOWN_B           (SPECIES_LEGACY_FORMS_START + 3)
#define SPECIES_UNOWN_C           (SPECIES_LEGACY_FORMS_START + 4)
#define SPECIES_UNOWN_D           (SPECIES_LEGACY_FORMS_START + 5)
#define SPECIES_UNOWN_E           (SPECIES_LEGACY_FORMS_START + 6)
#define SPECIES_UNOWN_F           (SPECIES_LEGACY_FORMS_START + 7)
#define SPECIES_UNOWN_G           (SPECIES_LEGACY_FORMS_START + 8)
#define SPECIES_UNOWN_H           (SPECIES_LEGACY_FORMS_START + 9)
#define SPECIES_UNOWN_I           (SPECIES_LEGACY_FORMS_START + 10)
#define SPECIES_UNOWN_J           (SPECIES_LEGACY_FORMS_START + 11)
#define SPECIES_UNOWN_K           (SPECIES_LEGACY_FORMS_START + 12)
#define SPECIES_UNOWN_L           (SPECIES_LEGACY_FORMS_START + 13)
#define SPECIES_UNOWN_M           (SPECIES_LEGACY_FORMS_START + 14)
#define SPECIES_UNOWN_N           (SPECIES_LEGACY_FORMS_START + 15)
#define SPECIES_UNOWN_O           (SPECIES_LEGACY_FORMS_START + 16)
#define SPECIES_UNOWN_P           (SPECIES_LEGACY_FORMS_START + 17)
#define SPECIES_UNOWN_Q           (SPECIES_LEGACY_FORMS_START + 18)
#define SPECIES_UNOWN_R           (SPECIES_LEGACY_FORMS_START + 19)
#define SPECIES_UNOWN_S           (SPECIES_LEGACY_FORMS_START + 20)
#define SPECIES_UNOWN_T           (SPECIES_LEGACY_FORMS_START + 21)
#define SPECIES_UNOWN_U           (SPECIES_LEGACY_FORMS_START + 22)
#define SPECIES_UNOWN_V           (SPECIES_LEGACY_FORMS_START + 23)
#define SPECIES_UNOWN_W           (SPECIES_LEGACY_FORMS_START + 24)
#define SPECIES_UNOWN_X           (SPECIES_LEGACY_FORMS_START + 25)
#define SPECIES_UNOWN_Y           (SPECIES_LEGACY_FORMS_START + 26)
#define SPECIES_UNOWN_Z           (SPECIES_LEGACY_FORMS_START + 27)
#define SPECIES_UNOWN_EXCLAMATION (SPECIES_LEGACY_FORMS_START + 28)
#define SPECIES_UNOWN_QUESTION    (SPECIES_LEGACY_FORMS_START + 29)

#define SPECIES_BURMY_SANDY    (SPECIES_LEGACY_FORMS_START + 30)
#define SPECIES_BURMY_TRASH    (SPECIES_LEGACY_FORMS_START + 31)
#define SPECIES_WORMADAM_SANDY (SPECIES_LEGACY_FORMS_START + 32)
#define SPECIES_WORMADAM_TRASH (SPECIES_LEGACY_FORMS_START + 33)

#define SPECIES_ARCEUS_FIGHTING (SPECIES_LEGACY_FORMS_START + 34)
#define SPECIES_ARCEUS_FLYING   (SPECIES_LEGACY_FORMS_START + 35)
#define SPECIES_ARCEUS_POISON   (SPECIES_LEGACY_FORMS_START + 36)
#define SPECIES_ARCEUS_GROUND   (SPECIES_LEGACY_FORMS_START + 37)
#define SPECIES_ARCEUS_ROCK     (SPECIES_LEGACY_FORMS_START + 38)
#define SPECIES_ARCEUS_BUG      (SPECIES_LEGACY_FORMS_START + 39)
#define SPECIES_ARCEUS_GHOST    (SPECIES_LEGACY_FORMS_START + 40)
#define SPECIES_ARCEUS_STEEL    (SPECIES_LEGACY_FORMS_START + 41)
#define SPECIES_ARCEUS_FAIRY    (SPECIES_LEGACY_FORMS_START + 42)
#define SPECIES_ARCEUS_FIRE     (SPECIES_LEGACY_FORMS_START + 43)
#define SPECIES_ARCEUS_WATER    (SPECIES_LEGACY_FORMS_START + 44)
#define SPECIES_ARCEUS_GRASS    (SPECIES_LEGACY_FORMS_START + 45)
#define SPECIES_ARCEUS_ELECTRIC (SPECIES_LEGACY_FORMS_START + 46)
#define SPECIES_ARCEUS_PSYCHIC  (SPECIES_LEGACY_FORMS_START + 47)
#define SPECIES_ARCEUS_ICE      (SPECIES_LEGACY_FORMS_START + 48)
#define SPECIES_ARCEUS_DRAGON   (SPECIES_LEGACY_FORMS_START + 49)
#define SPECIES_ARCEUS_DARK     (SPECIES_LEGACY_FORMS_START + 50)

#define SPECIES_SHAYMIN_SKY     (SPECIES_LEGACY_FORMS_START + 51)
#define SPECIES_ROTOM_HEAT      (SPECIES_LEGACY_FORMS_START + 52)
#define SPECIES_ROTOM_WASH      (SPECIES_LEGACY_FORMS_START + 53)
#define SPECIES_ROTOM_FROST     (SPECIES_LEGACY_FORMS_START + 54)
#define SPECIES_ROTOM_FAN       (SPECIES_LEGACY_FORMS_START + 55)
#define SPECIES_ROTOM_MOW       (SPECIES_LEGACY_FORMS_START + 56)
#define SPECIES_GIRATINA_ORIGIN (SPECIES_LEGACY_FORMS_START + 57)
#define SPECIES_PICHU_SPIKY_EAR (SPECIES_LEGACY_FORMS_START + 58)

#define MAX_SPECIES_LEGACY_FORM_NUM (SPECIES_PICHU_SPIKY_EAR)

#define MAX_SPECIES_CANONICAL_FORM_NUM (MAX_SPECIES_LEGACY_FORM_NUM)

#define SPECIES_MEGA_DECIDUEYE (MAX_SPECIES_CANONICAL_FORM_NUM + 1)
#define SPECIES_MEGA_INCINEROAR (MAX_SPECIES_CANONICAL_FORM_NUM + 2)
#define SPECIES_MEGA_PRIMARINA (MAX_SPECIES_CANONICAL_FORM_NUM + 3)
#define SPECIES_MEGA_DEDENNE (MAX_SPECIES_CANONICAL_FORM_NUM + 4)
#define SPECIES_MEGA_LEDIAN (MAX_SPECIES_CANONICAL_FORM_NUM + 5)
#define SPECIES_MEGA_MARSHADOW (MAX_SPECIES_CANONICAL_FORM_NUM + 6)

#define SPECIES_MEGA_JIRACHI (MAX_SPECIES_CANONICAL_FORM_NUM + 7)
#define SPECIES_MEGA_MEOWSCARADA (MAX_SPECIES_CANONICAL_FORM_NUM + 8)
#define SPECIES_MEGA_SKELEDIRGE (MAX_SPECIES_CANONICAL_FORM_NUM + 9)
#define SPECIES_MEGA_QUAQUAVAL (MAX_SPECIES_CANONICAL_FORM_NUM + 10)

#define SPECIES_ETERNAL_FRUIT_OGERPON (MAX_SPECIES_CANONICAL_FORM_NUM + 11)

#define MAX_UGH_FAKEMON (SPECIES_ETERNAL_FRUIT_OGERPON)

#define MAX_SPECIES_INCLUDING_FORMS (MAX_UGH_FAKEMON)  // 1476
...
#define SPECIES_SILVALLY_OVERWORLD_FIGHT    (SPECIES_OVERWORLD_GENDER_FORMS_START + 9)
#define SPECIES_SILVALLY_OVERWORLD_FLY      (SPECIES_OVERWORLD_GENDER_FORMS_START + 10)
#define SPECIES_SILVALLY_OVERWORLD_POISON   (SPECIES_OVERWORLD_GENDER_FORMS_START + 11)
#define SPECIES_SILVALLY_OVERWORLD_GROUND   (SPECIES_OVERWORLD_GENDER_FORMS_START + 12)
#define SPECIES_SILVALLY_OVERWORLD_ROCK     (SPECIES_OVERWORLD_GENDER_FORMS_START + 13)
#define SPECIES_SILVALLY_OVERWORLD_BUG      (SPECIES_OVERWORLD_GENDER_FORMS_START + 14)
#define SPECIES_SILVALLY_OVERWORLD_GHOST    (SPECIES_OVERWORLD_GENDER_FORMS_START + 15)
#define SPECIES_SILVALLY_OVERWORLD_STEEL    (SPECIES_OVERWORLD_GENDER_FORMS_START + 16)
#define SPECIES_SILVALLY_OVERWORLD_FAIRY    (SPECIES_OVERWORLD_GENDER_FORMS_START + 17)
#define SPECIES_SILVALLY_OVERWORLD_FIRE     (SPECIES_OVERWORLD_GENDER_FORMS_START + 18)
#define SPECIES_SILVALLY_OVERWORLD_WATER    (SPECIES_OVERWORLD_GENDER_FORMS_START + 19)
#define SPECIES_SILVALLY_OVERWORLD_GRASS    (SPECIES_OVERWORLD_GENDER_FORMS_START + 20)
#define SPECIES_SILVALLY_OVERWORLD_ELECTRIC (SPECIES_OVERWORLD_GENDER_FORMS_START + 21)
#define SPECIES_SILVALLY_OVERWORLD_PSYCHIC  (SPECIES_OVERWORLD_GENDER_FORMS_START + 22)
#define SPECIES_SILVALLY_OVERWORLD_ICE      (SPECIES_OVERWORLD_GENDER_FORMS_START + 23)
#define SPECIES_SILVALLY_OVERWORLD_DRAGON   (SPECIES_OVERWORLD_GENDER_FORMS_START + 24)
#define SPECIES_SILVALLY_OVERWORLD_DARK     (SPECIES_OVERWORLD_GENDER_FORMS_START + 25)
