...
#define SPECIES_BUNEARY_SAISANN (SPECIES_PALDEAN_FORMS_START + 27)
#define SPECIES_LOPUNNY_SAISANN (SPECIES_PALDEAN_FORMS_START + 28)
#define SPECIES_DEOXYS_ABSOLUTE (SPECIES_PALDEAN_FORMS_START + 29)
#define SPECIES_OGERPON_TEAL_MASK (SPECIES_PALDEAN_FORMS_START + 30)
#define SPECIES_MEWTWO_ARMORED (SPECIES_PALDEAN_FORMS_START + 31)
#define SPECIES_MAR (SPECIES_PALDEAN_FORMS_START + 32)
#define SPECIES_MEGA_LOPUNNY_SAISANN (SPECIES_PALDEAN_FORMS_START + 33)

#define MAX_SPECIES_INCLUDING_FORMS (SPECIES_MEGA_LOPUNNY_SAISANN)
