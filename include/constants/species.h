...
#define SPECIES_MEGA_VICTREEBEL (SPECIES_PLZA_FORMS_START + 1)
#define SPECIES_MEGA_STARMIE (SPECIES_PLZA_FORMS_START + 2)
#define SPECIES_MEGA_DRAGONITE (SPECIES_PLZA_FORMS_START + 3)
#define SPECIES_MEGA_MEGANIUM (SPECIES_PLZA_FORMS_START + 4)
#define SPECIES_MEGA_FERALIGATR (SPECIES_PLZA_FORMS_START + 5)
#define SPECIES_MEGA_SKARMORY (SPECIES_PLZA_FORMS_START + 6)
#define SPECIES_MEGA_FROSLASS (SPECIES_PLZA_FORMS_START + 7)
#define SPECIES_MEGA_EMBOAR (SPECIES_PLZA_FORMS_START + 8)
#define SPECIES_MEGA_EXCADRILL (SPECIES_PLZA_FORMS_START + 9)
#define SPECIES_MEGA_SCOLIPEDE (SPECIES_PLZA_FORMS_START + 10)
#define SPECIES_MEGA_SCRAFTY (SPECIES_PLZA_FORMS_START + 11)
#define SPECIES_MEGA_EELEKTROSS (SPECIES_PLZA_FORMS_START + 12)
#define SPECIES_MEGA_CHANDELURE (SPECIES_PLZA_FORMS_START + 13)
#define SPECIES_MEGA_CHESNAUGHT (SPECIES_PLZA_FORMS_START + 14)
#define SPECIES_MEGA_DELPHOX (SPECIES_PLZA_FORMS_START + 15)
#define SPECIES_MEGA_GRENINJA (SPECIES_PLZA_FORMS_START + 16)
#define SPECIES_MEGA_PYROAR (SPECIES_PLZA_FORMS_START + 17)
#define SPECIES_MEGA_FLOETTE (SPECIES_PLZA_FORMS_START + 18)
#define SPECIES_MEGA_MALAMAR (SPECIES_PLZA_FORMS_START + 19)
#define SPECIES_MEGA_BARBARACLE (SPECIES_PLZA_FORMS_START + 20)
#define SPECIES_MEGA_DRAGALGE (SPECIES_PLZA_FORMS_START + 21)
#define SPECIES_MEGA_HAWLUCHA (SPECIES_PLZA_FORMS_START + 22)
#define SPECIES_MEGA_ZYGARDE (SPECIES_PLZA_FORMS_START + 23)
#define SPECIES_MEGA_DRAMPA (SPECIES_PLZA_FORMS_START + 24)
#define SPECIES_MEGA_FALINKS (SPECIES_PLZA_FORMS_START + 25)
