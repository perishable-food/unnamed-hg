...
// pokémon follower specific overworlds start here... left off on gfx 1451 - galarian stunfisk which was inserted after all the others
	...
	{ .tag =  960, .gfx =  767, .callback_params = OVERWORLD_SIZE_SMALL}, // saisann
    { .tag =  961, .gfx =  768, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_LOPUNNY
	{ .tag =  962, .gfx =  768, .callback_params = OVERWORLD_SIZE_SMALL}, // saisann
    ...
    { .tag =  994, .gfx =  803, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_MANTYKE
    { .tag =  995, .gfx =  804, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_SNOVER
    ...
    { .tag = 1171, .gfx =  920, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_BASCULIN
    { .tag = 1172, .gfx =  921, .callback_params = OVERWORLD_SIZE_SMALL}, // red stripe
    ...
    { .tag = 1654, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // bloodmoon
    ...
    { .tag = 1662, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_FLORAGATO
    { .tag = 1663, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_MEOWSCARADA
    { .tag = 1664, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_FUECOCO
    { .tag = 1665, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_CROCALOR
    { .tag = 1666, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_SKELEDIRGE
    { .tag = 1667, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_QUAXLY
    { .tag = 1668, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_QUAXWELL
    { .tag = 1669, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_QUAQUAVAL
    { .tag = 1670, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_LECHONK
    { .tag = 1671, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_OINKOLOGNE
    { .tag = 1672, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // female
    { .tag = 1673, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TAROUNTULA
    { .tag = 1674, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_SPIDOPS
    { .tag = 1675, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_NYMBLE
    { .tag = 1676, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_LOKIX
    { .tag = 1677, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_PAWMI
    { .tag = 1678, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_PAWMO
    { .tag = 1679, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_PAWMOT
    { .tag = 1680, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TANDEMAUS
    { .tag = 1681, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_MAUSHOLD
    { .tag = 1682, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // family of three
    { .tag = 1683, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_FIDOUGH
    { .tag = 1684, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_DACHSBUN
    { .tag = 1685, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_SMOLIV
    { .tag = 1686, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_DOLLIV
    { .tag = 1687, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_ARBOLIVA
    { .tag = 1688, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_SQUAWKABILLY
    { .tag = 1689, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // blue
    { .tag = 1690, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // yellow
    { .tag = 1691, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // white
    { .tag = 1692, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_NACLI
    { .tag = 1693, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_NACLSTACK
    { .tag = 1694, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_GARGANACL
    { .tag = 1695, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_CHARCADET
    { .tag = 1696, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_ARMAROUGE
    { .tag = 1697, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_CERULEDGE
    { .tag = 1698, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TADBULB
    { .tag = 1699, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_BELLIBOLT
    { .tag = 1700, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_WATTREL
    { .tag = 1701, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_KILOWATTREL
    { .tag = 1702, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_MASCHIFF
    { .tag = 1703, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_MABOSSTIFF
    { .tag = 1704, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_SHROODLE
    { .tag = 1705, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_GRAFAIAI
    { .tag = 1706, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_BRAMBLIN
    { .tag = 1707, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_BRAMBLEGHAST
    { .tag = 1708, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TOEDSCOOL
    { .tag = 1709, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TOEDSCRUEL
    { .tag = 1710, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_KLAWF
    { .tag = 1711, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_CAPSAKID
    { .tag = 1712, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_SCOVILLAIN
    { .tag = 1713, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_RELLOR
    { .tag = 1714, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_RABSCA
    { .tag = 1715, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_FLITTLE
    { .tag = 1716, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_ESPATHRA
    { .tag = 1717, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TINKATINK
    { .tag = 1718, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TINKATUFF
    { .tag = 1719, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TINKATON
    { .tag = 1720, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_WIGLETT
    { .tag = 1721, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_WUGTRIO
    { .tag = 1722, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_BOMBIRDIER
    { .tag = 1723, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_FINIZEN
    { .tag = 1724, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_PALAFIN
    { .tag = 1725, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_VAROOM
    { .tag = 1726, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_REVAVROOM
    ...
    { .tag = 1732, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_CYCLIZAR
    { .tag = 1733, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_ORTHWORM
    { .tag = 1734, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_GLIMMET
    { .tag = 1735, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_GLIMMORA
    { .tag = 1736, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_GREAVARD
    { .tag = 1737, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_HOUNDSTONE
    { .tag = 1738, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_FLAMIGO
    { .tag = 1739, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_CETODDLE
    { .tag = 1740, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_CETITAN
    { .tag = 1741, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_VELUZA
    { .tag = 1742, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_DONDOZO
    { .tag = 1743, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TATSUGIRI
    { .tag = 1744, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // droopy
    { .tag = 1745, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // stretchy
    { .tag = 1746, .gfx =  1453, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_ANNIHILAPE
    { .tag = 1747, .gfx =  1454, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_CLODSIRE
    { .tag = 1748, .gfx =  1455, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_FARIGIRAF
    { .tag = 1749, .gfx =  1456, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_DUDUNSPARCE
    { .tag = 1750, .gfx =  1457, .callback_params = OVERWORLD_SIZE_LARGE}, // three segment
    { .tag = 1751, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_KINGAMBIT
    { .tag = 1752, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_GREAT_TUSK
    ...
    { .tag = 1755, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_FLUTTER_MANE
    ...
    { .tag = 1759, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_IRON_BUNDLE
    ...
    { .tag = 1763, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_IRON_THORNS
    ...
    { .tag = 1774, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_ROARING_MOON
    ...
    { .tag = 1778, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_WALKING_WAKE
    { .tag = 1779, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_IRON_LEAVES
    { .tag = 1780, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_DIPPLIN
    ...
    { .tag = 1787, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_ARCHALUDON
    { .tag = 1788, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_HYDRAPPLE
    { .tag = 1789, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_GOUGING_FIRE
    { .tag = 1790, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_RAGING_BOLT
    { .tag = 1791, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_IRON_BOULDER
    { .tag = 1792, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_IRON_CROWN
    { .tag = 1793, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TERAPAGOS
    { .tag = 1794, .gfx =  297, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_PECHARUNT
