...
// pokémon follower specific overworlds start here... left off on gfx 1451 - galarian stunfisk which was inserted after all the others
    ...
    { .tag = 1798, .gfx = 1553, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_SPECTREON
    { .tag = 1799, .gfx = 1554, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_BUFFUGU
    { .tag = 1800, .gfx = 1555, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_PUFFUGU
    { .tag = 1801, .gfx = 1556, .callback_params = OVERWORLD_SIZE_SMALL}, // SPECIES_TUFFUGU
    { 0xFFFF, 0, 0},
};
