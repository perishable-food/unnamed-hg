...
struct OVERWORLD_TAG gOWTagToFileNum[] = // skip down a bit to see the parts that are specifically for pokémon
    {
        ...
        MON_FOLLOWER_ENTRY(SPECIES_PICHU_SPIKY_EAR, OVERWORLD_SIZE_SMALL)
        ...
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_H, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_I, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_J, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_K, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_L, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_M, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_N, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_O, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_P, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_Q, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_R, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_S, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_T, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_U, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_V, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_W, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_X, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_Y, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_Z, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_EXCLAMATION, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_QUESTION, OVERWORLD_SIZE_SMALL)
        ...
        MON_FOLLOWER_ENTRY(SPECIES_BURMY_SANDY, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_BURMY_TRASH, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_WORMADAM, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_WORMADAM_SANDY, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_WORMADAM_TRASH, OVERWORLD_SIZE_SMALL)
        ...
        MON_FOLLOWER_ENTRY(SPECIES_ROTOM_HEAT, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ROTOM_WASH, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ROTOM_FROST, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ROTOM_FAN, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ROTOM_MOW, OVERWORLD_SIZE_SMALL)
        ...
        MON_FOLLOWER_ENTRY(SPECIES_GIRATINA_ORIGIN, OVERWORLD_SIZE_LARGE)
        ...
        MON_FOLLOWER_ENTRY(SPECIES_SHAYMIN_SKY, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_FIGHTING, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_FLYING, OVERWORLD_SIZE_LARGE)
        ...
        MON_FOLLOWER_ENTRY(SPECIES_OGERPON_TEAL_MASK_TERASTAL, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_OGERPON_WELLSPRING_MASK_TERASTAL, OVERWORLD_SIZE_SMALL) //filler
        MON_FOLLOWER_ENTRY(SPECIES_OGERPON_HEARTHFLAME_MASK_TERASTAL, OVERWORLD_SIZE_SMALL) //filler
        MON_FOLLOWER_ENTRY(SPECIES_OGERPON_CORNERSTONE_MASK_TERASTAL, OVERWORLD_SIZE_SMALL) //filler
        MON_FOLLOWER_ENTRY(SPECIES_ETERNAL_FRUIT_OGERPON, OVERWORLD_SIZE_SMALL)
        ...
        MON_FOLLOWER_ENTRY(SPECIES_SPECTREON, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_BUFFUGU, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_PUFFUGU, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_TUFFUGU, OVERWORLD_SIZE_SMALL)
