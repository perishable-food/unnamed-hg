...
const EvolutionTable __data[MAX_SPECIES_INCLUDING_FORMS + 1] =
{
    ...
    [SPECIES_VAPOREON] = {
        .entries = {
            { EVO_STONE, ITEM_EEVERSTONE, SPECIES_EEVEE },
            { EVO_NONE, 0, SPECIES_NONE },
            { EVO_NONE, 0, SPECIES_NONE },
            { EVO_NONE, 0, SPECIES_NONE },
            { EVO_NONE, 0, SPECIES_NONE },
    ...
    [SPECIES_BUFFUGU] = {
        .entries = {
            { EVO_FRIENDSHIP, 0, SPECIES_PUFFUGU },
            { EVO_NONE, 0, SPECIES_NONE },
            { EVO_NONE, 0, SPECIES_NONE },
            { EVO_NONE, 0, SPECIES_NONE },
            { EVO_NONE, 0, SPECIES_NONE },
    ...
    [SPECIES_PUFFUGU] = {
        .entries = {
            { EVO_STONE, ITEM_WATER_STONE, SPECIES_TUFFUGU },
            { EVO_NONE, 0, SPECIES_NONE },
            { EVO_NONE, 0, SPECIES_NONE },
            { EVO_NONE, 0, SPECIES_NONE },
            { EVO_NONE, 0, SPECIES_NONE },
