...
const u16 UNUSED FormReversionMapping[] =
{
...
#endif
    [SPECIES_GIGANTAMAX_TOXTRICITY_LOW_KEY - SPECIES_MEGA_START]        = 1,
    ...
    //[SPECIES_MEGA_ETERNAL_FRUIT_OGERPON - SPECIES_MEGA_START]         = 7, NOT IMPLEMENTED YET
    [SPECIES_MEGA_FLOETTE - SPECIES_MEGA_START]                         = 5,
    [SPECIES_MEGA_MEOWSTIC_FEMALE - SPECIES_MEGA_START]                 = 1,
    [SPECIES_MEGA_MAGEARNA_ORIGINAL - SPECIES_MEGA_START]               = 1,
    [SPECIES_MEGA_TATSUGIRI_DROOPY - SPECIES_MEGA_START]                = 1,
    [SPECIES_MEGA_TATSUGIRI_STRETCHY - SPECIES_MEGA_START]              = 1,
};
